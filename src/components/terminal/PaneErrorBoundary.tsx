    ...
    if (this.state.hasError) {
      return (
        <div className="h-full w-full flex flex-col items-center justify-center gap-3 bg-black p-4 select-none">
          <p className="text-xs text-[#a9a9aa] text-center max-w-[220px] leading-relaxed">
            This terminal pane hit an error and stopped rendering.
          </p>
          <button
            onClick={this.retry}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#5683da] hover:bg-[#5683da]/90 text-white text-[11px] font-medium transition-colors cursor-pointer"
          >

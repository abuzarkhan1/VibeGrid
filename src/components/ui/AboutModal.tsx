  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-md bg-surfaceCard border border-forest/25 rounded-xl shadow-[0_0_50px_rgba(44,122,64,0.2)] overflow-hidden flex flex-col backdrop-blur-md"
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-white/[0.06] bg-white/[0.03]">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 rounded-[6px] bg-forest flex items-center justify-center shadow-[0_0_14px_rgba(44,122,64,0.55)]">
        ...
        <div className="p-6 text-center space-y-4">
          <div className="mx-auto w-14 h-14 rounded-2xl bg-forest flex items-center justify-center shadow-[0_0_28px_rgba(84,169,103,0.45)]">

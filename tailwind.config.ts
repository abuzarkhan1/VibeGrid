  ...
  theme: {
    extend: {
      colors: {
        ...
        forest: {
          DEFAULT: 'var(--color-accent, #2c7a40)',
          bright: 'var(--color-accent, #54a967)',
          light: 'var(--color-accent, #6ec782)',
          dark: 'var(--color-surface, #1e542c)',
        },
        neon: 'var(--color-accent, #7cff3f)',
        bgDark: 'var(--color-bg, #03060a)',
        surfaceCard: 'var(--color-surface, rgba(15, 18, 22, 0.96))',
        'accent-primary': 'var(--color-accent, #2c7a40)',
        'accent-secondary': 'var(--color-accent, #54a967)',
        ...
        pane: {
          ...
          border: 'var(--color-border, rgba(255,255,255,0.07))',
          activeBorder: 'var(--color-accent, #54a967)',
        },
      },
      fontFamily: {
